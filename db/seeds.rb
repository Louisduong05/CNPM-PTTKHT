...
puts "===== Start adding Brand ====="
brand = Brand.create(name: "Apple", country: "USA")
brand2 = Brand.create(name: "Samsung", country: "Korean")
brand3 = Brand.create(name: "HTC", country: "Taiwan")
