...
ActiveRecord::Schema.define(version: 2021_01_05_092911) do
  ...
  create_table "pays", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pay_type_type", "pay_type_id"], name: "index_pays_on_pay_type_type_and_pay_type_id"
